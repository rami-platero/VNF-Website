  ...
  return (
    <div className={`about-us ${theme}`}>
      ...
      <div className="description-wrapper">
        <p>
          VIP NCS Fans is a community that shares facts about the record
          label NoCopyrightSounds that only some of the OG fans have known over
          the years.
        </p>
        <p>
        ...
        <p>
          We also have the purpose to show those fans who haven't been here for
          too long, all the media that has been recovered so far, such as:
        </p>
        <ul>
          <li>
            <strong>Backgrounds</strong>: Every image/video used for each video on the NCS YouTube channel.
          </li>
          <li>
            <strong>Deleted Songs</strong>: Songs/releases from every platform (Spotify, YouTube, SoundCloud,
            etc...)
          </li>
          <li>
